...
public strictfp class S2PolygonTest extends GeometryTestCase {
	...
	private static final String FAR1 = "0:179, -1:179, 1:180, -1:-179, 0:-179, 3:-178, 2:-180, 3:178;";
	...
	private static final String NEAR_FAR2 = "-8:-4, 8:-4, 2:15, 2:170, 8:-175, -8:-175, -2:170, -2:15;";
	...
	private static void assertContains(String aStr, String bStr) {
	...
	S2Polygon nf1n10f2s10abc = makePolygon(SOUTH0c + FAR2 + NEAR1 + NEAR_FAR1 + NEAR0 + SOUTH1 + SOUTH0b + SOUTH0a);

	S2Polygon nf2n2f210s210ab = makePolygon(
	...
	private static void assertRelation(S2Polygon a, S2Polygon b, int contains, boolean intersects) {
	...
	public void testRelations() {
		assertRelation(this.near10, this.near30, -1, true);
		assertRelation(this.near10, this.near32, 0, false);
		assertRelation(this.near10, this.near3210, -1, true);
		assertRelation(this.near10, this.nearH3210, 0, false);
		assertRelation(this.near30, this.near32, 1, true);
		assertRelation(this.near30, this.near3210, 1, true);
		assertRelation(this.near30, this.nearH3210, 0, true);
		assertRelation(this.near32, this.near3210, -1, true);
		assertRelation(this.near32, this.nearH3210, 0, false);
		assertRelation(this.near3210, this.nearH3210, 0, false);

		assertRelation(this.far10, this.far21, 0, false);
		assertRelation(this.far10, this.far321, -1, true);
		assertRelation(this.far10, this.farH20, 0, false);
		assertRelation(this.far10, this.farH3210, 0, false);
		assertRelation(this.far21, this.far321, 0, false);
		assertRelation(this.far21, this.farH20, 0, false);
		assertRelation(this.far21, this.farH3210, -1, true);
		assertRelation(this.far321, this.farH20, 0, true);
		assertRelation(this.far321, this.farH3210, 0, true);
		assertRelation(this.farH20, this.farH3210, 0, true);

		assertRelation(this.south0ab, this.south2, -1, true);
		assertRelation(this.south0ab, this.south210b, 0, true);
		assertRelation(this.south0ab, this.southH21, -1, true);
		assertRelation(this.south0ab, this.southH20abc, -1, true);
		assertRelation(this.south2, this.south210b, 1, true);
		assertRelation(this.south2, this.southH21, 0, true);
		assertRelation(this.south2, this.southH20abc, 0, true);
		assertRelation(this.south210b, this.southH21, 0, true);
		assertRelation(this.south210b, this.southH20abc, 0, true);
		assertRelation(this.southH21, this.southH20abc, 1, true);

		assertRelation(this.nf1n10f2s10abc, this.nf2n2f210s210ab, 0, true);
		assertRelation(this.nf1n10f2s10abc, this.near32, 1, true);
		assertRelation(this.nf1n10f2s10abc, this.far21, 0, false);
		assertRelation(this.nf1n10f2s10abc, this.south0ab, 0, false);
		assertRelation(this.nf1n10f2s10abc, this.f32n0, 1, true);

		assertRelation(this.nf2n2f210s210ab, this.near10, 0, false);
		assertRelation(this.nf2n2f210s210ab, this.far10, 1, true);
		assertRelation(this.nf2n2f210s210ab, this.south210b, 1, true);
		assertRelation(this.nf2n2f210s210ab, this.south0ab, 1, true);
		assertRelation(this.nf2n2f210s210ab, this.n32s0b, 1, true);
	}
	...
	// polygons.add(adj0);
	// polygons.add(adj1);
	// S2Polygon union = S2Polygon.destructiveUnionSloppy(polygons,
	// S1Angle.degrees(0.1));
	//
	...
	public void testGetDistance() {
		...
		assertEquals(0d, rect
				.getDistance(S2Point.normalize(S2Point.add(rect.loop(0).vertex(0), rect.loop(0).vertex(1)))).radians(),
				epsilon);

...
public strictfp class S2RegionCovererTest extends GeometryTestCase {
	...
	public void checkCovering(S2RegionCoverer coverer, S2Region region, ArrayList<S2CellId> covering,
			boolean interior) {
	...
	public void testRandomCaps() {
		...
		for (int i = 0; i < 1000; ++i) {
			...
			double maxArea = Math.min(4 * S2.M_PI,
					(3 * coverer.maxCells() + 1) * S2Cell.averageArea(coverer.minLevel()));

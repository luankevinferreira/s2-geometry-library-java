...
public strictfp class S2EdgeUtilTest extends GeometryTestCase {
	...
	private static void assertCrossing(S2Point a, S2Point b, S2Point c, S2Point d, int robust, boolean edgeOrVertex,
			boolean simple) {
	...
	private static void assertCrossings(S2Point a, S2Point b, S2Point c, S2Point d, int robust, boolean edgeOrVertex,
			boolean simple) {
	...
	public void testCrossings() {
		...
		assertCrossings(new S2Point(1, 2, 1), new S2Point(1, -3, 0.5), new S2Point(1, -0.5, -3),
				new S2Point(0.1, 0.5, 3), 1, true, true);

		// Two regular edges that cross antipodal points.
		assertCrossings(new S2Point(1, 2, 1), new S2Point(1, -3, 0.5), new S2Point(-1, 0.5, 3),
				new S2Point(-0.1, -0.5, -3), -1, false, true);

		// Two edges on the same great circle.
		assertCrossings(new S2Point(0, 0, -1), new S2Point(0, 1, 0), new S2Point(0, 1, 1), new S2Point(0, 0, 1), -1,
				false, true);

		// Two edges that cross where one vertex is S2.Origin().
		assertCrossings(new S2Point(1, 0, 0), new S2Point(0, 1, 0), new S2Point(0, 0, 1), new S2Point(1, 1, -1), 1,
				true, true);
		...
		assertCrossings(new S2Point(2, 3, 4), new S2Point(-1, 2, 5), new S2Point(7, -2, 3), new S2Point(2, 3, 4), 0,
				false, true);

		// Two edges that barely cross edge other.
		assertCrossings(new S2Point(1, 1, 1), new S2Point(1, 1 - 1e-15, -1), new S2Point(-1, -1, 0),
				new S2Point(1, 1, 0), 1, true, false);
	}
	...
	public void testRectBounder() {
		...
		assertTrue(getEdgeBound(1, 1, 1, 1, -1, -1).lat().approxEquals(new R1Interval(-kCubeLat, kCubeLat)));
		assertTrue(getEdgeBound(1, -1, 1, 1, 1, -1).lat().approxEquals(new R1Interval(-kCubeLat, kCubeLat)));
	}

	// Produce a normalized S2Point for testing.
	private static S2Point S2NP(double x, double y, double z) {
	...
	private static void assertWedge(S2Point a0, S2Point ab1, S2Point a2, S2Point b0, S2Point b2, boolean contains,
			boolean intersects, boolean crosses) {
	...
	public void testWedges() {
		...
		assertWedge(new S2Point(-1, 0, 10), new S2Point(0, 0, 1), new S2Point(1, 2, 10), new S2Point(0, 1, 10),
				new S2Point(1, -2, 10), false, true, true);
		// Intersection in two wedges.
		assertWedge(new S2Point(-1, -1, 10), new S2Point(0, 0, 1), new S2Point(1, -1, 10), new S2Point(1, 0, 10),
				new S2Point(-1, 1, 10), false, true, true);

		// Normal containment.
		assertWedge(new S2Point(-1, -1, 10), new S2Point(0, 0, 1), new S2Point(1, -1, 10), new S2Point(-1, 0, 10),
				new S2Point(1, 0, 10), true, true, false);
		// Containment with equality on one side.
		assertWedge(new S2Point(2, 1, 10), new S2Point(0, 0, 1), new S2Point(-1, -1, 10), new S2Point(2, 1, 10),
				new S2Point(1, -5, 10), true, true, false);
		// Containment with equality on the other side.
		assertWedge(new S2Point(2, 1, 10), new S2Point(0, 0, 1), new S2Point(-1, -1, 10), new S2Point(1, -2, 10),
				new S2Point(-1, -1, 10), true, true, false);
		// Containment with equality on both sides.
		assertWedge(new S2Point(-2, 3, 10), new S2Point(0, 0, 1), new S2Point(4, -5, 10), new S2Point(-2, 3, 10),
				new S2Point(4, -5, 10), true, true, false);

		// Disjoint with equality on one side.
		assertWedge(new S2Point(-2, 3, 10), new S2Point(0, 0, 1), new S2Point(4, -5, 10), new S2Point(4, -5, 10),
				new S2Point(-2, -3, 10), false, false, false);
		// Disjoint with equality on the other side.
		assertWedge(new S2Point(-2, 3, 10), new S2Point(0, 0, 1), new S2Point(0, 5, 10), new S2Point(4, -5, 10),
				new S2Point(-2, 3, 10), false, false, false);
		...
		assertWedge(new S2Point(2, 1, 10), new S2Point(0, 0, 1), new S2Point(1, -5, 10), new S2Point(2, 1, 10),
				new S2Point(-1, -1, 10), false, true, false);
		// B contains A with equality on the other side.
		assertWedge(new S2Point(2, 1, 10), new S2Point(0, 0, 1), new S2Point(1, -5, 10), new S2Point(-2, 1, 10),
				new S2Point(1, -5, 10), false, true, false);
	}
	...
	private static void checkDistance(S2Point x, S2Point a, S2Point b, double distanceRadians,
			S2Point expectedClosest) {
	...
	public void testGetDistance() {
		checkDistance(new S2Point(1, 0, 0), new S2Point(1, 0, 0), new S2Point(0, 1, 0), 0, new S2Point(1, 0, 0));
		checkDistance(new S2Point(0, 1, 0), new S2Point(1, 0, 0), new S2Point(0, 1, 0), 0, new S2Point(0, 1, 0));
		checkDistance(new S2Point(1, 3, 0), new S2Point(1, 0, 0), new S2Point(0, 1, 0), 0, new S2Point(1, 3, 0));
		checkDistance(new S2Point(0, 0, 1), new S2Point(1, 0, 0), new S2Point(0, 1, 0), Math.PI / 2,
				new S2Point(1, 0, 0));
		checkDistance(new S2Point(0, 0, -1), new S2Point(1, 0, 0), new S2Point(0, 1, 0), Math.PI / 2,
				new S2Point(1, 0, 0));
		checkDistance(new S2Point(-1, -1, 0), new S2Point(1, 0, 0), new S2Point(0, 1, 0), 0.75 * Math.PI,
				new S2Point(0, 0, 0));
		...
		checkDistance(new S2Point(-1, -1, 0), new S2Point(1, 0, 0), new S2Point(-1, 1, 0), Math.PI / 2,
				new S2Point(-1, 1, 0));
		checkDistance(new S2Point(1, 1, 1), new S2Point(1, 0, 0), new S2Point(0, 1, 0), Math.asin(Math.sqrt(1. / 3)),
				new S2Point(1, 1, 0));
		checkDistance(new S2Point(1, 1, -1), new S2Point(1, 0, 0), new S2Point(0, 1, 0), Math.asin(Math.sqrt(1. / 3)),
				new S2Point(1, 1, 0));
		...
		checkDistance(new S2Point(0, 0, -1), new S2Point(1, 1, 0), new S2Point(1, 1, 0), Math.PI / 2,
				new S2Point(1, 1, 0));
		checkDistance(new S2Point(-1, 0, 0), new S2Point(1, 0, 0), new S2Point(1, 0, 0), Math.PI, new S2Point(1, 0, 0));
	}
	...
	public void testIntersectionTolerance() {
		...
		for (int i = 0; i < 1000; ++i) {
			...
			double slope = Math.pow(1e-15, this.rand.nextDouble());
			d2 = S2Point.add(d1, S2Point.mul(d2, slope));
			S2Point a = S2Point
					.normalize(S2Point.add(p, S2Point.mul(d1, Math.pow(1e-15 / slope, this.rand.nextDouble()))));
			S2Point b = S2Point
					.normalize(S2Point.sub(p, S2Point.mul(d1, Math.pow(1e-15 / slope, this.rand.nextDouble()))));
			S2Point c = S2Point
					.normalize(S2Point.add(p, S2Point.mul(d2, Math.pow(1e-15 / slope, this.rand.nextDouble()))));
			S2Point d = S2Point
					.normalize(S2Point.sub(p, S2Point.mul(d2, Math.pow(1e-15 / slope, this.rand.nextDouble()))));

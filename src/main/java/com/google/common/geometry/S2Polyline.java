 ...
 *
 * <p>
 * Note: Polylines do not have a Contains(S2Point) method, because "containment"
...
public final strictfp class S2Polyline implements S2Region {
	 ...
	 * allowed. Adjacent vertices should not be identical or antipodal. All vertices
	...
	/**
	 * Return the point whose distance from vertex 0 along the polyline is the given
	 * fraction of the polyline's total length. Fractions less than zero or greater
	 * than one are clamped. The return value is unit length. This cost of this
	 * function is currently linear in the number of vertices.
	 */
	...
	public boolean equals(Object that) {
		...
		for (int i = 0; i < this.vertices.length; i++) {
			if (!this.vertices[i].equals(thatPolygon.vertices[i])) {
				return false;
			}
		}
		return true;

...
public strictfp class S2LatLng {
	...
	public double latDegrees() {
		return 180.0 / Math.PI * this.latRadians;
	}
	...
	public double lngDegrees() {
		return 180.0 / Math.PI * this.lngRadians;
	}
	 ...
	 * </ul>
	 * <p>
	 * If the current point is valid then the returned point will have the same
	 * coordinates.
	 */
	...
	/**
	 * Adds the given point to this point. Note that there is no guarantee that the
	 * new point will be <em>valid</em>.
	 */
	...
	/**
	 * Subtracts the given point from this point. Note that there is no guarantee
	 * that the new point will be <em>valid</em>.
	 */
	...
	/**
	 * Scales this point by the given scaling factor. Note that there is no
	 * guarantee that the new point will be <em>valid</em>.
	 */
	...
	public int hashCode() {
		long value = 17;
		value += 37 * value + Double.doubleToLongBits(this.latRadians);
		value += 37 * value + Double.doubleToLongBits(this.lngRadians);
		return (int) (value ^ (value >>> 32));
	}

	/**
	 * Returns true if both the latitude and longitude of the given point are within
	 * {@code maxError} radians of this point.
	 */
	...
	/**
	 * Returns true if the given point is within {@code 1e-9} radians of this point.
	 * This corresponds to a distance of less than {@code 1cm} at the surface of the
	 * Earth.
	 */

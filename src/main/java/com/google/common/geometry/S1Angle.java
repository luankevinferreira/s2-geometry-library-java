...
public final strictfp class S1Angle implements Comparable<S1Angle> {
	...
	/**
	 * Writes the angle in degrees with a "d" suffix, e.g. "17.3745d". By default 6
	 * digits are printed; this can be changed using setprecision(). Up to 17 digits
	 * are required to distinguish one angle from another.
	 */
	@Override
